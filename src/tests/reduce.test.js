...
describe('tests for method reduce', () => {
  ...
  test(`If an array is empty but there is 
        an InitialValue as a parameter`, () => {
  ...
  test(`reduce callback takes first element as a value 
        of first parameter if initialValue is not passed`, () => {
